import { BoundInfo, SnappableProps, RotatableProps, MoveableManagerInterface } from "../../types";
export declare function checkBoundPoses(moveable: MoveableManagerInterface<SnappableProps>, verticalPoses: number[], horizontalPoses: number[]): {
    vertical: BoundInfo;
