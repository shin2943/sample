...
import { MoveableManagerState, Able, MoveableClientRect, MoveableProps, ControlPose, MoveableManagerInterface } from "./types";
...
export declare function getOffsetPosInfo(el: HTMLElement | SVGElement, container: SVGElement | HTMLElement | null, style: CSSStyleDeclaration, isFixed: boolean): {
    isSVG: boolean;
    hasOffset: boolean;
    offset: number[];
    origin: number[];
...
export declare function getMatrixStackInfo(target: SVGElement | HTMLElement, container: SVGElement | HTMLElement | null, prevMatrix?: number[]): {
...
export declare function caculateMatrixStack(target: SVGElement | HTMLElement, container: SVGElement | HTMLElement | null, rootContainer: SVGElement | HTMLElement | null, prevMatrix?: number[], prevRootMatrix?: number[], prevN?: number): [number[], number[], number[], number[], number[], string, number[], number[], boolean];
...
export declare function caculateMoveablePosition(matrix: number[], origin: number[], width: number, height: number): [number[], number[], number[][], 1 | -1];
...
export declare function getLineStyle(pos1: number[], pos2: number[], rad?: number): {
    transform: string;
    width: string;
};
...
export declare function getTargetInfo(moveableElement?: HTMLElement, target?: HTMLElement | SVGElement, container?: HTMLElement | SVGElement | null, parentContainer?: HTMLElement | SVGElement | null, rootContainer?: HTMLElement | SVGElement | null, state?: Partial<MoveableManagerState> | false | undefined): Partial<MoveableManagerState>;
...
export declare function fillParams<T extends IObject<any>>(moveable: any, e: any, params: Pick<T, Exclude<keyof T, "target" | "clientX" | "clientY" | "inputEvent" | "datas" | "currentTarget">>): T;
export declare function fillEndParams<T extends IObject<any>>(moveable: any, e: any, params: Pick<T, Exclude<keyof T, "target" | "clientX" | "clientY" | "inputEvent" | "datas" | "currentTarget" | "lastEvent" | "isDrag" | "isDouble">> & {
    isDrag?: boolean;
}): T;
export declare function triggerEvent<T extends IObject<any> = MoveableProps, U extends keyof T = string>(moveable: any, name: U & string, params: T[U] extends ((e: infer P) => any) | undefined ? P : IObject<any>, isManager?: boolean): any;
...
export declare function caculateInversePosition(matrix: number[], pos: number[], n: number): number[];
export declare function convertDragDist(state: MoveableManagerState, e: any): any;
export declare function caculatePadding(matrix: number[], pos: number[], transformOrigin: number[], origin: number[], n: number): number[];
export declare function checkSize(targetSize: number[], compareSize: number[], isMax: boolean): number[];
export declare function caculateBoundSize(size: number[], minSize: number[], maxSize: number[], keepRatio?: boolean): number[];
export declare function getUnitSize(pos: string, size: number): number;
export declare function convertCSSSize(value: number, size: number, isRelative?: boolean): string;
export declare function moveControlPos(controlPoses: ControlPose[], nextPoses: number[][], index: number, distX: number, distY: number): void;
