...
import { MoveableManagerProps, MoveableManagerState, Able, RectInfo, Requester, HitRect } from "./types";
...
declare const ControlBoxElement: {
    ...
    injector: import("css-styled").StyledInjector;
